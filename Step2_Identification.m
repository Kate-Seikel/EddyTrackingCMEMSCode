...
function Step2_Identification(basepath, min_amp, min_R, fullextract)
...
input_dir =  '/Volumes/NEMO3/GOFFISH/Emily/Programs/Eddy_Tracking_CMEMS_NEW/EXTRACTION/INDIVIDUAL_FILES';
...
switch Extraction_Type
        ...
        for i=[1:length(list)]
            ...
            if Ncyclo>0
                for j=1:Ncyclo %Loop on each Cyclone
                    ...
                    % Mean EKE
                    Cyclonic_Cell{j,10}=single(mean(EKE(INDinside),'omitnan'));
            ...
            if Nanti>0
                for j=1:Nanti %Loop on each Cyclone
                    ...
                    % Mean EKE
                    Anticyclonic_Cell{j,10}=single(mean(EKE(INDinside),'omitnan'));
            ...
            eval([' save -append ' filename ' Anticyclonic_Cell Cyclonic_Cell Nanti Ncyclo Fields Label_cyclo Label_anti'])
    ...
    case 'Full Extraction'
        ...
        for i=1:366
            ...
            % Saves cells and variables in .mat file
            eval([' save -append ' filename ' Anticyclonic_Cell Cyclonic_Cell Nanti Ncyclo Fields Uinside_cyclo Uinside_anti Vinside_cyclo Vinside_anti Label_cyclo Label_anti'])
