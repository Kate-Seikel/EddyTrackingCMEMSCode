...
function Step3_Merge_eddymat_BoB(basepath, fullextract)
...
output_dir = [strcat(basepath, 'EXTRACTION/EDDY_PROPERTIES')]; %EDDY_PROPERTIES/2018'];
[status,message,messageid] = mkdir(output_dir);

input_dir= [strcat(basepath, 'EXTRACTION/INDIVIDUAL_FILES')]; %INDIVIDUAL_FILES/'];
...
for i=1:1:n_day-1 %732:1096 %367:731 %1:366
...
switch Extraction_Type
    ...
    renvar SSH SSH
        ...
        save(filename_out_c,'X','Y','Xcenter','Ycenter','Xcentroid','Ycentroid','Radius','Area','Amplitude','EKE','date_num','Ncyclo','id_cyclo');
        ...
        save(filename_out_a,'X','Y','Xcenter','Ycenter','Xcentroid','Ycentroid','Radius','Area','Amplitude','EKE','date_num','Nanti','id_anti');
        ...
        save(filename_cont,'-v7.3','X','Y','CEs','AEs','Fields_cont','id_cyclo','Ncyclo','id_anti','Nanti','date_num');
    ...
    case 'Full Extraction'
        ...
        save(filename_out_c,'-v7.3','X','Y','Xcenter','Ycenter','Xcentroid','Ycentroid','Radius','Area','Amplitude','EKE','Speed','Vorticity','Vorticity_center','Vorticity_center_normalized_f','Ss','Sn','OW','date_num','Ncyclo','id_cyclo');
        ...
        save(filename_out_a,'-v7.3','X','Y','Xcenter','Ycenter','Xcentroid','Ycentroid','Radius','Area','Amplitude','EKE','Speed','Vorticity','Vorticity_center','Vorticity_center_normalized_f','Ss','Sn','OW','date_num','Nanti','id_anti');
